    ...
    <footer className="bg-gray-900 text-white mt-16">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-xl font-bold font-serif mb-4">Alternativa Socialista Internacional</h3>
            <p className="text-gray-300 text-sm mb-4"
               style={{margin: "0px 0px 16px"}}>
              Entregando las últimas noticias y actualizaciones de todo el mundo. 
              Mantente informado con nuestra cobertura integral.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Sobre Nosotros</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Contacto</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Carreras</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Publicidad</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors text-sm">Términos de Uso</a></li>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-bold mb-4" style={{margin: "0px 0px 16px"}}
            >Contáctanos </h3>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
             
                {/* 
                   <MapPin className="text-accent-600 mt-1" size={18} />
                <div>
              ...
              <div className="flex items-center space-x-3" style={{margin: "16px 0px 0px"}}>
              ...
              <div className="flex items-center space-x-3" style={{margin: "16px 0px 0px"}}>
                <Mail className="text-[#DC2626]" size={18} />
                <p className="text-gray-300 text-sm">
                  asichile1@gmail.com
                </p>
              </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6">
          <p className="text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} NewsFlash. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
